...
plt.figure(4)
#plt.plot(time_array, g_r_color_array, linestyle='-', marker='', label='Average g-r')
plt.plot(g_r_color_array, mag_diff_time_array, linestyle='-', marker='', label='MaxMass g-r')



#PLOTTING
#-------------------------------------
figure_name="Jan30HW1P1Luminosity.png"
plot_title="Luminosity vs. Time"  #Can code the number in with treemax
x_axis="Time [Gyrs]"
y_axis="Luminosity [solar units]"

figure_name2="Jan30HW1P1Magnitudes.png"
...
figure_name3="Jan30HW1P2Colors.png"
plot_title3="Average Color vs. Time"  #Can code the number in with treemax
x_axis3="Time [Gys]"
y_axis3="Average Color: g - r"

figure_name4="Jan30HW1P3CompareColorMag.png"
plot_title4="Color vs. Mag Difference"  #Can code the number in with treemax
x_axis4="Mag Difference M(t) - M(t=0)"
y_axis4="Average Color: g - r"
